...
complete -c niri -n "__fish_niri_needs_command" -f -a "msg" -d 'Communicate with the running niri instance'
complete -c niri -n "__fish_niri_needs_command" -f -a "validate" -d 'Validate the config file'
complete -c niri -n "__fish_niri_needs_command" -f -a "panic" -d 'Cause a panic to check if the backtraces are good'
complete -c niri -n "__fish_niri_needs_command" -f -a "completions" -d 'Generate shell completions'
complete -c niri -n "__fish_niri_needs_command" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
